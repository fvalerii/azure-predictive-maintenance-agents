...
# =============================================================================
# Foundry Deployment — Infrastructure Deployment Script
...
RESOURCE_GROUP="${RESOURCE_GROUP:-foundry-tireforge-rg-$SUFFIX}"
...
echo "=============================================="
echo "  Foundry Deployment — Infrastructure Deploy"
echo "=============================================="
echo ""
echo "Suffix:            $SUFFIX"
...
cat > "$ENV_FILE" << EOF
# =============================================================================
# Foundry Deployment — Environment Variables
